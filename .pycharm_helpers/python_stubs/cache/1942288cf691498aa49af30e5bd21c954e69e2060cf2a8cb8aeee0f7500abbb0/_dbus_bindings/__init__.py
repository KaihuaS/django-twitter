...
NULL_MAIN_LOOP = None # (!) real value is '<dbus.mainloop.NativeMainLoop object at 0x7fedd9c381b0>'

_C_API = None # (!) real value is '<capsule object "_dbus_bindings._C_API" at 0x7fedd9c38180>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7feddad66978>'

__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7feddad66978>, origin='/usr/lib/python3/dist-packages/_dbus_bindings.cpython-36m-x86_64-linux-gnu.so')"
