...
openssl_md_meth_names = None # (!) real value is "frozenset({'whirlpool', 'sm3', 'sha3-256', 'sha512', 'md5-sha1', 'md4', 'blake2b512', 'sha3-224', 'sha224', 'sha3-512', 'sha512-256', 'ripemd160', 'sha512-224', 'sha3-384', 'md5', 'blake2s256', 'sha256', 'shake256', 'shake128', 'sha1', 'sha384'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7feddad1bc50>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7feddad1bc50>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
